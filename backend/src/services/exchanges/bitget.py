"""
Bitget 거래소 REST API 클라이언트

CCXT를 사용한 Bitget 선물 거래 구현
"""
...
class BitgetExchange(BaseExchange):
    ...
    def __init__(self, api_key: str, secret_key: str, passphrase: str):
        ...
        Args:
            api_key: API 키
            secret_key: Secret 키
            passphrase: API Passphrase (Bitget 필수)
        """
        ...
        self.exchange = ccxt.bitget({
            'apiKey': api_key,
            'secret': secret_key,
            'password': passphrase,  # Bitget은 password 필드에 passphrase 사용
    ...
    async def get_balance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget get_balance error: {e}")
            raise
    ...
    async def get_futures_balance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget get_futures_balance error: {e}")
            raise
    ...
    async def create_order(
        ...
        try:
            ...
            logger.error(f"Bitget create_order error: {e}")
            raise
    ...
    async def cancel_order(self, order_id: str, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget cancel_order error: {e}")
            raise
    ...
    async def get_order(self, order_id: str, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget get_order error: {e}")
            raise
    ...
    async def get_open_orders(self, symbol: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Bitget get_open_orders error: {e}")
            raise
    ...
    async def get_positions(self, symbol: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Bitget get_positions error: {e}")
            raise
    ...
    async def close_position(self, symbol: str, side: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget close_position error: {e}")
            raise
    ...
    async def get_ticker(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget get_ticker error: {e}")
            raise
    ...
    async def get_candles(
        ...
        try:
            ...
            logger.error(f"Bitget get_candles error: {e}")
            raise
    ...
    async def set_leverage(self, symbol: str, leverage: int) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget set_leverage error: {e}")
            raise
    ...
    async def get_funding_rate(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bitget get_funding_rate error: {e}")
            raise

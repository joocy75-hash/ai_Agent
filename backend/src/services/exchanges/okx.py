...
class OKXExchange(BaseExchange):
    ...
    def __init__(self, api_key: str, secret_key: str, passphrase: str):
        ...
        Args:
            api_key: API 키
            secret_key: Secret 키
            passphrase: API Passphrase (OKX 필수)
        """
        ...
        self.exchange = ccxt.okx({
            'apiKey': api_key,
            'secret': secret_key,
            'password': passphrase,  # OKX는 password 필드에 passphrase 사용
    ...
    async def get_futures_balance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"OKX get_futures_balance error: {e}")
            raise
    ...
    async def get_order(self, order_id: str, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"OKX get_order error: {e}")
            raise
    ...
    async def get_positions(self, symbol: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"OKX get_positions error: {e}")
            raise
    ...
    async def close_position(self, symbol: str, side: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"OKX close_position error: {e}")
            raise
    ...
    async def get_candles(
        ...
        try:
            ...
            logger.error(f"OKX get_candles error: {e}")
            raise
    ...
    async def set_leverage(self, symbol: str, leverage: int) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"OKX set_leverage error: {e}")
            raise
    ...
    async def get_funding_rate(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"OKX get_funding_rate error: {e}")
            raise

...
class GateioExchange(BaseExchange):
    ...
    def __init__(self, api_key: str, secret_key: str):
        ...
        Args:
            ...
            secret_key: Secret 키
        """
        super().__init__(api_key, secret_key, None)  # Gate.io는 passphrase 불필요
    ...
    async def get_balance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io get_balance error: {e}")
            raise
    ...
    async def get_futures_balance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io get_futures_balance error: {e}")
            raise
    ...
    async def create_order(
        ...
        try:
            ...
            logger.error(f"Gate.io create_order error: {e}")
            raise
    ...
    async def cancel_order(self, order_id: str, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io cancel_order error: {e}")
            raise
    ...
    async def get_order(self, order_id: str, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io get_order error: {e}")
            raise
    ...
    async def get_open_orders(self, symbol: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Gate.io get_open_orders error: {e}")
            raise
    ...
    async def get_positions(self, symbol: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Gate.io get_positions error: {e}")
            raise
    ...
    async def close_position(self, symbol: str, side: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io close_position error: {e}")
            raise
    ...
    async def get_ticker(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io get_ticker error: {e}")
            raise
    ...
    async def get_candles(
        ...
        try:
            ...
            logger.error(f"Gate.io get_candles error: {e}")
            raise
    ...
    async def set_leverage(self, symbol: str, leverage: int) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io set_leverage error: {e}")
            raise
    ...
    async def get_funding_rate(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Gate.io get_funding_rate error: {e}")
            raise

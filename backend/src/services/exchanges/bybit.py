"""
Bybit 거래소 REST API 클라이언트

CCXT를 사용한 Bybit USDT-M 선물 거래 구현
"""
...
class BybitExchange(BaseExchange):
    ...
    def __init__(self, api_key: str, secret_key: str):
        ...
        Args:
            ...
            secret_key: Secret 키
        """
        super().__init__(api_key, secret_key, None)  # Bybit은 passphrase 불필요
        ...
        self.exchange = ccxt.bybit({
            ...
            'options': {
                'defaultType': 'swap',  # USDT-M 선물 (Linear Perpetual)
            }
        })
    ...
    async def get_futures_balance(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bybit get_futures_balance error: {e}")
            raise
    ...
    async def close_position(self, symbol: str, side: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Bybit close_position error: {e}")
            raise
    ...
    async def get_candles(
        ...
        try:
            ...
            logger.error(f"Bybit get_candles error: {e}")
            raise
